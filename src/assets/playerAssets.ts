...
import _imgButtonsGuardElevLeft from './player-buttons-guard-elev-left.svg'
import _imgButtonsGuardElevLeft1 from './player-buttons-guard-elev-left-1.svg'
import _imgLines1 from './player-lines-1.svg'
import _imgButtonGuard from './player-button-guard.svg'
import _imgGroup10 from './player-group10.svg'
import _imgBackTape from './player-back-tape.svg'
import _imgReelLeft from './player-reel-left.svg'
import _imgReelRight from './player-reel-right.svg'
import _imgLine14 from './player-line14.svg'
import _imgButtonOffset from './player-button-offset.svg'
import _imgButtonGradiant from './player-button-gradient.svg'
import _imgNextButton from './player-btn-next.svg'
import _imgPrevButton from './player-btn-prev.svg'
import _imgPauseButton from './player-btn-pause.svg'
import _imgStopButton from './player-btn-stop.svg'
import _imgPlayButton from './player-btn-play.svg'
import _imgEjectButton from './player-btn-eject.svg'
import _imgSpeaker from './player-speaker.svg'
import _imgLine1 from './player-line1.svg'
import _imgLine2 from './player-line2.svg'
import _imgVolumeSliderNob from './player-vol-slider-knob.svg'
import _imgTapeTypeNobSelector from './player-tape-type-knob.svg'
